...
;; Copyright (C) 1997-2023  The PARI group.
...
;; pari-fontification.el version 3.21
...
(defvar pari-fontification-keywords
  (list
   ...
   '("\\(|\\|<-\\|\\.\\.\\|&\\)" (0 gp-default-keywords))
    '("\\<\\(return\\|break\\|next\\|if\\|iferr\\|until\\|while\\|sum\\|for\\(div\\|prime\\|step\\|vec\\|subgroup\\|squarefree\\|composite\\|divfactored\\|part\\|qfvec\\|perm\\|primestep\\|subset\\)?\\|my\\|local\\)\\>" (1 gp-control-statement))
    ...
    '("\\<\\(parsum\\|parvector\\|parselect\\|export\\|exportall\\|unexportall\\|pareval\\|parapply\\|parfor\\|parforprime\\|parploth\\)\\>" (1 gp-parallel-stuff))
    )
  ...
  (defface gp-parallel-stuff
    '((((class grayscale) (background light)) (:foreground "DimGray" :italic t))
      ...
      (((class color) (background dark)) (:foreground "OrangeRed" :background "Orchid"
                                                      :italic t))
      (t (:italic t)))
    "*Face used in GP to highlight parallel instructions.")
  (defface gp-typing
    '((((class grayscale) (background light)) (:foreground "DimGray" :italic t))
      (((class grayscale) (background dark)) (:foreground "LightGray" :italic t))
      (((class color) (background light)) (:foreground "tomato" :background "snow1"
...
(defun gp-update-fontification nil "Update fontification."
  ...
  (when gp-fontifyp ;;(print "Yo")
    ...
    ;(save-excursion (font-lock-fontify-region (point-min) (point-max) t)) ;; TO BE REMOVED!!
    (font-lock-flush)))
